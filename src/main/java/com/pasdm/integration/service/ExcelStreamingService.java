...
import com.pasdm.integration.factory.SheetHandlerFactory;
import com.pasdm.integration.infraestructure.nas.NasSmbClient;
...
public class ExcelStreamingService {
    ...
    public void readExcel(String excelPath, SheetType type) {
                ...
                try (InputStream sheetStream = sheets.next()) {
                    ...
                    if (type == SheetType.PLANT) {
                        ...
                        if ("Budget".equals(sheetName)) {
                            ...
                            sheetHandler = sheetHandlerFactory.get(SheetType.PLANT);
                        } else {
                        ...
                        XMLReader parser = XMLHelper.newXMLReader();
                        ExcelSheetHandler sheetHandler = sheetHandlerFactory.get(type);
                        //PROCESADOR DE CELDAS
                        ContentHandler handler = new XSSFSheetXMLHandler(
                                styles,
                                sharedStrings,
